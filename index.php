...
#==================================================================================
    ...
    // Defined to give version for library files
    defined('LIBRARY_VERSION')
    || define('LIBRARY_VERSION', "v=v1.0.0-krs&amp;pm=v0.0.1.2");
    ...
    if (!defined("JAVASCRIPT_PATH"))  define("JAVASCRIPT_PATH", SITE_URL . "public/javascripts");
